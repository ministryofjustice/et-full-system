    ...
    module Et3Export
      ...
      def calculated_response_matchers(args)
        [
          ...
          "~2.4 How would you prefer us to communicate with you?: #{args.dig(:respondent, :contact_preference)}",
          ...
          "~7.6 How would they prefer us to communicate with them?: #{args.dig(:representative, :representative_contact_preference).downcase}",
