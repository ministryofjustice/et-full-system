    ...
    module Et1Export
      ...
      def calculated_claim_matchers(args)
        [
          ...
          "~1.7 How would you prefer us to communicate with you?: #{args.dig(:user, :correspondence)}",
          ...
          "Respondent name: #{args.dig(:respondent, :name)}",
          '~2.2 Address:',
          "Respondent Address 1: #{args.dig(:respondent, :building)}",
          "Respondent Address 2: #{args.dig(:respondent, :street)}",
          "Respondent Address 3: #{args.dig(:respondent, :locality)}",
          "Respondent Address 4: #{args.dig(:respondent, :county)}",
          "Respondent Postcode: #{args.dig(:respondent, :post_code)}",
          "Respondent Phone: #{args.dig(:respondent, :telephone_number)}",
          "~2.3 If you worked at an address different from the one you have given at 2.2, please give the full address:",
          "Alternative Respondent Address1: #{args.dig(:respondent).dig(:work_address, :building)}",
          "Alternative Respondent Address2: #{args.dig(:respondent).dig(:work_address, :street)}",
          "Alternative Respondent Address3: #{args.dig(:respondent).dig(:work_address, :locality)}",
          "Alternative Respondent Address4: #{args.dig(:respondent).dig(:work_address, :county)}",
          "Alternative Postcode: #{args.dig(:respondent).dig(:work_address, :post_code)}",
          "Alternative Phone: #{args.dig(:respondent).dig(:work_address, :telephone_number)}",
          '',
          ...
          '',
          "Name of your employer of the organisation you are claiming against1: #{args.dig(:respondent)[1].try(:dig, :name)}",
          'Address:',
          "AdditionalAddress1 1: #{args.dig(:respondent)[1].try(:dig, :building)}",
          "AdditionalAddress1 2: #{args.dig(:respondent)[1].try(:dig, :street)}",
          "AdditionalAddress1 3: #{args.dig(:respondent)[1].try(:dig, :locality)}",
          "AdditionalAddress1 4: #{args.dig(:respondent)[1].try(:dig, :county)}",
          "AdditionalPostcode1: #{args.dig(:respondent)[1].try(:dig, :post_code)}",
          "AdditionalPhoneNumber1: #{args.dig(:respondent)[1].try(:dig, :telephone_number)}",
          "Name of your employer of the organisation you are claiming against2: #{args.dig(:respondent)[2].try(:dig, :name)}",
          "Address:",
          "AdditionalAddress2 1: #{args.dig(:respondent)[2].try(:dig, :building)}",
          "AdditionalAddress2 2: #{args.dig(:respondent)[2].try(:dig, :street)}",
          "AdditionalAddress2 3: #{args.dig(:respondent)[2].try(:dig, :locality)}",
          "AdditionalAddress2 4: #{args.dig(:respondent)[2].try(:dig, :county)}",
          "AdditionalPostcode2: #{args.dig(:respondent)[2].try(:dig, :post_code)}",
          "AdditionalPhoneNumber2: #{args.dig(:respondent)[2].try(:dig, :telephone_number)}",
          "Name of your employer of the organisation you are claiming against3: #{args.dig(:respondent)[3].try(:dig, :name)}",
          "Address:",
          "AdditionalAddress3 1: #{args.dig(:respondent)[3].try(:dig, :building)}",
          "AdditionalAddress3 2: #{args.dig(:respondent)[3].try(:dig, :street)}",
          "AdditionalAddress3 3: #{args.dig(:respondent)[3].try(:dig, :locality)}",
          "AdditionalAddress3 4: #{args.dig(:respondent)[3].try(:dig, :county)}",
          "AdditionalPostcode3: #{args.dig(:respondent)[3].try(:dig, :post_code)}",
          "AdditionalPhoneNumber3: #{args.dig(:respondent)[3].try(:dig, :telephone_number)}"
        ]
      end
