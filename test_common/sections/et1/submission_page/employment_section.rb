    ...
    module Et1
      module SubmissionPageSections
        class EmploymentSection < BaseSection
          ...
          section :notice_period, :govuk_summary_list_row, :'review.employment.questions.notice_period.title' do
            element :answer, :govuk_summary_list_col
          end
          ...
          section :average_weekly_hours_worked, :govuk_summary_list_row,
                  :'review.employment.questions.average_weekly_hours_worked' do
            element :answer, :govuk_summary_list_col
          end
          ...
          section :notice_period_end_date, :govuk_summary_list_row,
                  :'review.employment.questions.notice_period_end_date' do
            element :answer, :govuk_summary_list_col
          end
          section :pay_before_tax_at_new_job, :govuk_summary_list_row,
                  :'review.employment.questions.pay_before_tax_at_new_job' do
            element :answer, :govuk_summary_list_col
          end
          section :employed_by_employer, :govuk_summary_list_row,
                  :'review.employment.questions.employed_by_employer.title' do
            element :answer, :govuk_summary_list_col
          end
          ...
          def has_correct_translation?(employment:)
            if employment.present?
              aggregate_failures 'validating employment section with employment populated' do
                ...
                expect(pay_before_tax).to have_answer(text: with_money_not_entered(employment.pay_before_tax,
                                                                                   employment.pay_period_type))
                expect(pay_after_tax).to have_answer(text: with_money_not_entered(employment.pay_after_tax,
                                                                                  employment.pay_period_type))
