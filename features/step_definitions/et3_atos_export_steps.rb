...
Then(/^my entered data is formatted into a PDF file for my ET3 reference number and is available for ATOS to download$/) do
  ...
  expect { atos_interface }.to eventually have_zip_file_containing(:et3_response_pdf_for, user: et3_helper.user, reference: @my_et3_reference), timeout: 30, sleep: 2
  tempfile = atos_interface.download_from_any_zip_to_tempfile(:et3_response_pdf_for, user: et3_helper.user, reference: @my_et3_reference)
