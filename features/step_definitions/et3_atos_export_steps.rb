Then(/^I can download the ET3 form and validate in TXT format$/) do
  ...
  expect(atos_interface.download_from_any_zip(:et3_response_txt_for, user: @respondent, reference: @my_et3_reference)).to match_text_schema calculated_response_matchers(user: @claimant[0], representative: @representative[0], respondent: @respondent)
end
