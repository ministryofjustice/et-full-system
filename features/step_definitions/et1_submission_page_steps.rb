...
Then(/^I should see a valid submission page$/) do
  et1_submission_page.has_correct_translation?(claimants: @claimants, respondents: @respondents, claim: @claim, employment: @employment, representative: @representatives.first)
end
